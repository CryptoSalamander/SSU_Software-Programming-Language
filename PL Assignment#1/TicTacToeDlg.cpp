...
void CTicTacToeDlg::OnBnClickedB1()
{
	...
	m_board.board[0][0] = 'X';
	m_board.moveCnt++;
	m_board.preMoves[m_board.moveCnt].x = 0;
	m_board.preMoves[m_board.moveCnt].y = 0;
	StartGame();
}
...
void CTicTacToeDlg::OnBnClickedB2()
{
	...
	m_board.moveCnt++;
	m_board.preMoves[m_board.moveCnt].x = 0;
	m_board.preMoves[m_board.moveCnt].y = 1;
	StartGame();
}
...
void CTicTacToeDlg::OnBnClickedB3()
{
	...
	m_board.moveCnt++;
	m_board.preMoves[m_board.moveCnt].x = 0;
	m_board.preMoves[m_board.moveCnt].y = 2;
	StartGame();
}
...
void CTicTacToeDlg::OnBnClickedB4()
{
	...
	m_board.moveCnt++;
	m_board.preMoves[m_board.moveCnt].x = 0;
	m_board.preMoves[m_board.moveCnt].y = 3;
	StartGame();
}
...
void CTicTacToeDlg::OnBnClickedB5()
{
	...
	m_board.board[1][0] = 'X';
	m_board.moveCnt++;
	m_board.preMoves[m_board.moveCnt].x = 1;
	m_board.preMoves[m_board.moveCnt].y = 0;
	StartGame();
}
...
void CTicTacToeDlg::OnBnClickedB9()
{
	...
	m_board.moveCnt++;
	m_board.preMoves[m_board.moveCnt].x = 2;
	m_board.preMoves[m_board.moveCnt].y = 0;
	StartGame();
}
...
void CTicTacToeDlg::OnBnClickedB13()
{
	...
	m_board.board[3][0] = 'X';
	m_board.moveCnt++;
	m_board.preMoves[m_board.moveCnt].x = 3;
	m_board.preMoves[m_board.moveCnt].y = 0;
	StartGame();
}
